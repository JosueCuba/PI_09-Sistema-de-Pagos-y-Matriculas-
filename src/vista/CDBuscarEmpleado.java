...
import controlador.ADNEmpleado;
 ...
 * @author Josue Cuba
 */
public class CDBuscarEmpleado extends javax.swing.JDialog {

    /**
     * Creates new form CDBuscarEmpleado
     */
    public CDBuscarEmpleado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        FIUsuario.idemp = Integer.parseInt(dtm.getValueAt(indice, 0).toString());
        FIUsuario.nomemp = dtm.getValueAt(indice, 1).toString() + " " + dtm.getValueAt(indice, 2).toString();
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CDBuscarEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CDBuscarEmpleado dialog = new CDBuscarEmpleado(new javax.swing.JFrame(), true);
