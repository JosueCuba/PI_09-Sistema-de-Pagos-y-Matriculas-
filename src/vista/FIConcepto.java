 ...
 * @author Josue Cuba
 */
public class FIConcepto extends javax.swing.JInternalFrame {
    ...
    public static Date fec;
    public static float pre=0f;
    /**
    ...
    private void initComponents() {
        ...
        snrprecio.setModel(new javax.swing.SpinnerNumberModel(0.0f, null, 9999.0f, 10.0f));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            String nom = tbxnombre.getText().trim();
            String fecha = Formatos.sdtfecha.format( dtpfecha.getDate());
            Date fechasql= Formatos.Fechasql(fecha);
            float precio = Float.parseFloat(snrprecio.getValue().toString());
            boolean gua = ADNConcepto.Guardar(new Concepto(idcon, nom, fechasql, precio, "1"));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        if (FIListaConceptos.modif) {
            tbxnombre.setText(nom);
            dtpfecha.setDate(fec);
            snrprecio.setValue(pre);
        }
