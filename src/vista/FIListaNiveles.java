 ...
 * @author Josue Cuba
 */
public class FIListaNiveles extends javax.swing.JInternalFrame {

    /**
     * Creates new form FIListaNiveles
     */
    public FIListaNiveles() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Registro de niveles academicos");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod. Nivel", "Tutor", "Tutor", "Grado", "Orden", "Nro Vacantes", "Estado"
            }
        ));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        FINivel.idniv = Integer.parseInt(dtm.getValueAt(indice, 0).toString());
    ...
    private void btnmodificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmodificarActionPerformed
        try {
            modif = true;
            FINivel.idniv = Integer.parseInt(dtm.getValueAt(jTable1.getSelectedRow(), 0).toString());
            FINivel.idemp = Integer.parseInt(dtm.getValueAt(jTable1.getSelectedRow(), 1).toString());
            FINivel.nomtutor = dtm.getValueAt(jTable1.getSelectedRow(), 2).toString();
//            FINivel.idemp2 = Integer.parseInt(dtm.getValueAt(jTable1.getSelectedRow(), 3).toString());
//            FINivel.nomcotutor = dtm.getValueAt(jTable1.getSelectedRow(), 4).toString();
            FINivel.grado = dtm.getValueAt(jTable1.getSelectedRow(), 3).toString();
            FINivel.orden = dtm.getValueAt(jTable1.getSelectedRow(), 4).toString();
            FINivel.nrovacantes = Integer.parseInt(dtm.getValueAt(jTable1.getSelectedRow(), 5).toString());
            FINivel.estado = dtm.getValueAt(jTable1.getSelectedRow(), 6).toString();
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        try {
            Nivel con = new Nivel();
            con.setIdNivel(FINivel.idniv);
            boolean elim = ADNNivel.Eliminar(con);
            if (elim) {
    ...
    public void VerDatos() throws ClassNotFoundException, SQLException {
        try {
            ...
            for (Nivel a : ADNNivel.ListaNiveles()) {
