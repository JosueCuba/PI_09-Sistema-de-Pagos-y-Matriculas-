 ...
 * @author Josue Cuba
 */
public class FIListaUsuarios extends javax.swing.JInternalFrame {

    /**
     * Creates new form FIListaUsuarios
     */
    public FIListaUsuarios() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IdUsuario", "IdEmpleado", "Nick", "Clave", "Tipo"
            }
        ));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        FIUsuario.idusu = Integer.parseInt(dtm.getValueAt(indice,0).toString());
    ...
    private void btnmodificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmodificarActionPerformed
        try {
            modif = true;
            FIUsuario.idusu = Integer.parseInt(dtm.getValueAt(jTable1.getSelectedRow(), 0).toString());
            FIUsuario.idemp = Integer.parseInt(dtm.getValueAt(jTable1.getSelectedRow(), 1).toString());
            FIUsuario.nick = dtm.getValueAt(jTable1.getSelectedRow(), 2).toString();
            FIUsuario.clave = dtm.getValueAt(jTable1.getSelectedRow(), 3).toString();
            FIUsuario.tipo = (String) dtm.getValueAt(jTable1.getSelectedRow(), 4);
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        try {
            Usuario alu = new Usuario();
            alu.setIdusuario(FIUsuario.idusu);
            boolean elim = ADNUsuario.Eliminar(alu);
            if (elim) {
    ...
    public void VerDatos(String ape) throws ClassNotFoundException, SQLException {
        try {
            ...
            for (Usuario a : ADNUsuario.ListaUsuarios()) {
