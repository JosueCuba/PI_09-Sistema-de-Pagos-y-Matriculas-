 ...
 * @author Josue Cuba
 */
public class FIListaConceptos extends javax.swing.JInternalFrame {

    /**
     * Creates new form FIListaConceptos
     */
    public FIListaConceptos() {
        initComponents();
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        FIConcepto.idcon = Integer.parseInt(dtm.getValueAt(indice,0).toString());
    ...
    private void btnmodificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmodificarActionPerformed
        try {
            modif = true;
            FIConcepto.idcon = Integer.parseInt(dtm.getValueAt(jTable1.getSelectedRow(), 0).toString());
            FIConcepto.nom = dtm.getValueAt(jTable1.getSelectedRow(), 1).toString();
            FIConcepto.fec = Formatos.Fechasql(dtm.getValueAt(jTable1.getSelectedRow(), 2).toString());
            FIConcepto.pre = Float.parseFloat(dtm.getValueAt(jTable1.getSelectedRow(), 3).toString());
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        try {
            ...
            con.setIdconcepto(FIConcepto.idcon);
