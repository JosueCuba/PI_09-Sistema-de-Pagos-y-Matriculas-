 ...
 * @author Josue Cuba
 */
public class FIListaAlumnos extends javax.swing.JInternalFrame {

    /**
     * Creates new form FIListaAlumnos
     */
    public FIListaAlumnos() {
        initComponents();
    }
    ...
    private void btnmodificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmodificarActionPerformed
        try {
            modif = true;
            FIAlumno.idalu = Integer.parseInt(dtm.getValueAt(jTable1.getSelectedRow(), 0).toString());
            FIAlumno.nombres = dtm.getValueAt(jTable1.getSelectedRow(), 1).toString();
            FIAlumno.apellidos = dtm.getValueAt(jTable1.getSelectedRow(), 2).toString();
            FIAlumno.dni = dtm.getValueAt(jTable1.getSelectedRow(), 3).toString();
            FIAlumno.sexo = (String) dtm.getValueAt(jTable1.getSelectedRow(), 4);
            FIAlumno.fecnac = Formatos.Fechasql(dtm.getValueAt(jTable1.getSelectedRow(), 5).toString());
            FIAlumno.nompadre = dtm.getValueAt(jTable1.getSelectedRow(), 6).toString();
            FIAlumno.nommadre = dtm.getValueAt(jTable1.getSelectedRow(), 7).toString();
            FIAlumno.nomapoderado = dtm.getValueAt(jTable1.getSelectedRow(), 8).toString();
            FIAlumno.telefono = dtm.getValueAt(jTable1.getSelectedRow(), 9).toString();
            FIAlumno.celular = dtm.getValueAt(jTable1.getSelectedRow(), 10).toString();
            FIAlumno.direccion = dtm.getValueAt(jTable1.getSelectedRow(), 11).toString();
            FIAlumno.distrito = dtm.getValueAt(jTable1.getSelectedRow(), 12).toString();
            FIAlumno.estado = (String) dtm.getValueAt(jTable1.getSelectedRow(), 13);
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        try {
            ...
            alu.setIdalumno(FIAlumno.idalu);
            boolean elim = ADNAlumno.Eliminar(alu);
            if (elim) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        FIAlumno.idalu = Integer.parseInt(dtm.getValueAt(indice,0).toString());
    ...
    public void VerDatos(String ape) throws ClassNotFoundException, SQLException {
        try {
            ...
            for (Alumno a : ADNAlumno.ListaAlumno(alu)) {
